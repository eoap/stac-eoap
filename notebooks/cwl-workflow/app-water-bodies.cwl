...
$graph:
  - class: Workflow
    ...
    doc: Water bodies detection based on NDWI and otsu threshold applied to a single Landsat-9 acquisition
    requirements: []
    inputs:
      aoi:
  ...
  - class: CommandLineTool
    ...
    outputs:
      stac-catalog:
        ...
        type: Directory
s:codeRepository:
  URL: https://github.com/eoap/quickwin-inline-code.git
s:author:
  - class: s:Person
    s.name: Jane Doe
